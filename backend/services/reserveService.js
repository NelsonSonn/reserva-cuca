...
const createReserve = async (reserveData) => {
  ...
  //se a reserva começa dia 31 e acaba dia 5, startDate é maior que newDate, mas não tá errada.
  //como verificar, nesse caso?

  if (new Date(startDate) > new Date(endDate)) {
    throw new Error('Start date must be before end time.');
  }
