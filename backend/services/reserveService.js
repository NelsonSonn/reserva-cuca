...
const createReserve = async (reserveData) => {
  ...
  try {
    ...
    /*
      A transação (transaction) no Sequelize é usada para garantir que um conjunto de operações no banco de dados 
      seja executado de forma atômica. Isso significa que todas as operações dentro da transação são concluídas com sucesso ou 
      nenhuma delas é aplicada, garantindo a integridade dos dados.
    */
